...
const reloadButton = document.getElementById("reload-patient-btn");
  ...
  if (macAddress) {
    try {
      ...
      if (
        ...
        const sensorData1 = patientInfo.sensor_data || [];
        patientCondition.textContent = sensorData1[0].condition || "N/A";
        const sensorData = patientInfo.sensor_data.slice().reverse(); // Reverse the order
...
// Save the current selection before reloading
